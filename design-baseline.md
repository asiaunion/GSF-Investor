...
Status: ⚠️ 복구 작업 필요 (현재 코드가 이 사양과 불일치)
...
- [ ] 대시보드 (/): 카드 상단 보더, 섹션 구분선
- [ ] 관심종목 (/stocks): 동일 카드 스타일
- [ ] 공시 (/disclosures): 동일 카드 스타일
- [ ] 시그널 (/signals): 동일 카드 스타일
- [ ] 매매일지 (/journal): 동일 카드 스타일
- [ ] AI 보고서 (/reports): 동일 카드 스타일
- [ ] 종목 발굴 (/discover): 동일 카드 스타일
- [ ] 설정 (/settings): 동일 카드 스타일
