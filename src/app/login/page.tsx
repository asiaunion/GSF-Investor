      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-bg-surface border border-border-default rounded-2xl p-8 shadow-2xl">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-100 text-zinc-900 font-medium py-3 px-4 rounded-xl transition-colors duration-150 cursor-pointer"
          >
